...
abstract class Model {
    ...
    public function errorMessages()
    {
        return [
            ...
            self::RULE_MIN => 'Min length of this field muse be {min}',
    ...
    public function getLabel($attriubute)
    {
        return $this->labels()[$attriubute] ?? $attriubute;
    }
        ...
        foreach ($this->rules() as $attribute => $rules) {
            ...
            foreach ($rules as $rule) {
                ...
                if ($ruleName === self::RULE_UNIQUE) {
                    ...
                    $uniqueAttribute = $rule['attriubute'] ?? $attribute;
    ...
    public function getFirstError($attriubute)
    {
        return $this->errors[$attriubute][0] ?? false;
    }
